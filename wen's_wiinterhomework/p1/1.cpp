...
int main(int argc, char *argv[]) {
    ...
    // for (int i = 0; i < row; i++) {
    //     cout << ans_new[col - 1][i].getLeft() << " " << ans_new[col - 1][i].getUp() << " " << ans_new[col - 1][i].getRight() << " " << ans_new[col - 1][i].getDown() << endl;
    // }
